...
class MA_DisjunctiveConditionsRemover(DisjunctiveConditionsRemover):
    ...
    def get_fresh_name_ag(
        Self, agent: Agent, original_name: str, parameters_names: Iterable[str] = []
    ) -> str:
        """This method returns a fresh name for the agent, given a name and an iterable of names in input."""
