...
class PDDLWriter:
    ...
    def get_item_named(
        ...
        """
        Since pddl has a scricter set of possible naming compared to the unified_planning, when writing
        a up Problem it is possible that some things must be renamed. This is why the PDDLWriter offers the method
        get_item_named that takes a pddl name and returnes the original up data structure that corresponds to the pddl entity
        with the given name.
        ...
        :return: The up.model entity corresponding to the given name.
        """
        try:
    ...
    def get_pddl_name(
        ...
        :param item: The up.model entity renamed by this PDDLWriter.
