...
class TestProblem(TestCase):
    ...
    def test_robot(self):
        ...
        self.assertEqual(robot_at.signature, [up.model.Parameter('position', Location, problem.env)])
    ...
    def test_robot_loader(self):
        ...
        self.assertEqual(cargo_at.signature, [up.model.Parameter('position', Location, problem.env)])
    ...
    def test_robot_loader_adv(self):
        ...
        self.assertEqual(robot_at.signature, [up.model.Parameter('robot', Robot, problem.env),
        ...
        self.assertEqual(cargo_at.signature, [up.model.Parameter('cargo', Container, problem.env),
                                              up.model.Parameter('position', Location, problem.env)])
        self.assertTrue(cargo_at.type.is_bool_type())
        ...
        self.assertEqual(cargo_mounted.signature, [up.model.Parameter('cargo', Container, problem.env),
    ...
    def test_htn_problem_creation(self):
        ...
        self.assertEqual(["go-noop", "go-recursive"], [method.name for method in problem.methods])
