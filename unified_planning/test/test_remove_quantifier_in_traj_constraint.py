...
class TestRemoveQuantifierInTrajConstraint(TestCase):
    ...
    def test_remove_external_forall(self):
        ...
        new_constrs = self.simplifier.simplify(And(self.traj_remover._remove_quantifire(problem.trajectory_constraints)))
        self.assertTrue(new_constrs.is_and())
        self.assertTrue(len(new_constrs.args) == len(self.get_all_variable_by_type(problem.all_objects, s_loc.type)))
    ...
    def test_remove_internal_forall(self):
        ...
        self.assertTrue(len(new_constrs.args[0].args) == len(self.get_all_variable_by_type(problem.all_objects, s_loc.type)))
