...
class TestNegativeConditionsRemover(unittest_TestCase):
    ...
    def test_objects(self):
        ...
        compiled_action.add_precondition(Or(Equals(ux, u2), Equals(ux, u3)))
        compiled_action.add_precondition(Or(Equals(uy, u1), Equals(uy, u3)))
        compiled_tca = test_constant_action.clone()
        compiled_tca.clear_preconditions()
        compiled_tca.add_precondition(False)
        ...
        self.assertEqual(compiled_tca, comp_res.problem.action("tca"))
    ...
    def test_booleans(self):
        ...
        compiled_iff_action.add_precondition(
    ...
    def test_boolean_more_complex(self):
        ...
        compiled_action.add_precondition(temp_exp_4)
        ncr = NegativeConditionsRemover()
        comp_res = ncr.compile(problem, CompilationKind.NEGATIVE_CONDITIONS_REMOVING)
        assert isinstance(comp_res.problem, Problem)
        self.assertEqual(compiled_action, comp_res.problem.action("test_action"))
