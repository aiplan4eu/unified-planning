(define (domain depot-domain)
 ...
 (:action drive
  ...
  :precondition (and 
   ('(pos ?driver1_agent y)', [bool driving[truck=truck - locatable], bool pos[place=place]])
   ('(at_ ?x_0 ?y_0)', [bool driving[truck=truck - locatable], bool pos[place=place]])
   ('(driving ?driver1_agent x)', [bool driving[truck=truck - locatable], bool pos[place=place]])
  )
  :effect (and
