(define (domain depot-domain)
 ...
 (:action drive
  ...
  :precondition (and 
   ('(pos ?driver0_agent y)', [bool driving[truck=truck - locatable], bool pos[place=place]])
   ('(at_ ?x_0 ?y_0)', [bool driving[truck=truck - locatable], bool pos[place=place]])
   ('(driving ?driver0_agent x)', [bool driving[truck=truck - locatable], bool pos[place=place]])
  )
  :effect (and
