(define (domain depot-domain)
 ...
 (:action lift
  ...
  :precondition (and 
   ('(pos ?distributor0_agent p)', [bool lifting[hoist=hoist - locatable, crate=crate - surface], bool available[hoist=hoist - locatable], bool pos[place=place]])
   ('(at_ ?x ?p)', [bool lifting[hoist=hoist - locatable, crate=crate - surface], bool available[hoist=hoist - locatable], bool pos[place=place]])
   ('(available ?distributor0_agent x)', [bool lifting[hoist=hoist - locatable, crate=crate - surface], bool available[hoist=hoist - locatable], bool pos[place=place]])
 ...
 (:action drop
  ...
  :precondition (and 
   ...
   ('(lifting ?distributor0_agent x)', [bool lifting[hoist=hoist - locatable, crate=crate - surface], bool available[hoist=hoist - locatable], bool pos[place=place]])
  )
  :effect (and
