...
def get_example_problems():
    ...
    truck0_a = Agent("truck0_a", problem)
    truck1_a = Agent("truck1_a", problem)
    env = MAEnvironment(problem)

    truck0_a.add_action(drive)
    truck1_a.add_action(drive)
    ...
    depot0_a.add_fluent(at, default_initial_value=False)
    depot0_a.add_fluent(on, default_initial_value=False)
    depot0_a.add_fluent(In, default_initial_value=False)
    depot0_a.add_fluent(clear, default_initial_value=False)
    depot0_a.add_fluent(lifting, default_initial_value=False)
    depot0_a.add_fluent(available, default_initial_value=False)
    depot0_a.add_fluent(available_, default_initial_value=False)

    distributor0_a.add_fluent(at, default_initial_value=False)
    distributor0_a.add_fluent(on, default_initial_value=False)
    distributor0_a.add_fluent(In, default_initial_value=False)
    distributor0_a.add_fluent(clear, default_initial_value=False)
    ...
    distributor0_a.add_fluent(available_, default_initial_value=False)

    distributor1_a.add_fluent(at, default_initial_value=False)
    distributor1_a.add_fluent(on, default_initial_value=False)
    distributor1_a.add_fluent(In, default_initial_value=False)
    distributor1_a.add_fluent(clear, default_initial_value=False)
    ...
    distributor1_a.add_fluent(available_, default_initial_value=False)

    depot0_a.add_fluent(pos)
    distributor0_a.add_fluent(pos)
    distributor1_a.add_fluent(pos)
    truck0_a.add_fluent(pos)
    truck1_a.add_fluent(pos)

    depot0_a.add_fluent(ok)

    problem.add_agent(depot0_a)
    problem.add_agent(distributor0_a)
    problem.add_agent(distributor1_a)
    problem.add_agent(truck0_a)
    problem.add_agent(truck1_a)

    truck0_place = Object("truck0_place", truck)
    truck1_place = Object("truck1_place", truck)
    ...
    problem.add_object(truck0_place)  # agente
    problem.add_object(truck1_place)  # agente
    ...
    problem.set_initial_value(at(truck0_place, distributor1_place), True)
    problem.set_initial_value(at(truck1_place, depot0_place), True)
    ...
    problem.set_initial_value(Dot(truck0_a, pos(distributor0_place)), True)
    problem.set_initial_value(Dot(truck1_a, pos(depot0_place)), True)
    problem.set_initial_value(Dot(depot0_a, available_(hoist0)), True)
    problem.set_initial_value(Dot(distributor0_a, available_(hoist1)), True)
    problem.set_initial_value(Dot(distributor1_a, available_(hoist2)), True)
