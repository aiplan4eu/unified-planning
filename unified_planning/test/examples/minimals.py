...
def get_example_problems():
    ...
    problem.add_goal(x)
    plan = up.plans.SequentialPlan([up.plans.ActionInstance(a_y), up.plans.ActionInstance(a_x)])
    ...
    problem.add_goal(z)
    plan = up.plans.SequentialPlan([up.plans.ActionInstance(a_2_act),
    ...
    plan = up.plans.TimeTriggeredPlan([(Fraction(0, 1), up.plans.ActionInstance(take_ok, (ObjectExp(o1), ObjectExp(o2))), Fraction(3, 1)),
                                      (Fraction(1, 1), up.plans.ActionInstance(set_giver, (ObjectExp(o2), )), Fraction(2, 1))])
    ...
    plan = up.plans.SequentialPlan([up.plans.ActionInstance(b),
                                   up.plans.ActionInstance(c)])
    ...
    plan = up.plans.SequentialPlan([up.plans.ActionInstance(increase), up.plans.ActionInstance(increase)])
