...
def get_example_problems():
    ...
    #we = Fluent("we", ok=ok)
    #problem.ma_environment.add_private_fluent(we, default_initial_value=False)
    ...
    #person1.add_private_fluent(empty, default_initial_value=False, private=True)
    ...
    #drive_t.add_precondition(pos(from_))
    ...
    #problem.set_initial_value(Dot(driver1, pos(g1)), True)
    #problem.set_initial_value(Dot(driver2, pos(g2)), True)
    ...
    w.write_ma_domain('driver2')
    w.write_ma_problem('driver2')
