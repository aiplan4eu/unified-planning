(define (problem p_g-problem)
 (:domain p_g-domain)
 (:objects
   home drawer pouchposedrawer vision2 pickup bin binup scalerest scaleout pouchposescale scaleup mark10 mark10rest mark10out mark10up pouchposemark10 - location
