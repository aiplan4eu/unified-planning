...
from unified_planning.model import Fluent, MultiAgentProblem, InstantaneousAction, DurativeAction, FNode, Action, Effect, Timing
...
class NegativeConditionsRemover(Transformer):
    ...
    def __init__(self, problem: MultiAgentProblem, name: str = 'ncrm'):
    ...
    def get_rewritten_problem(self) -> MultiAgentProblem:
        ...
        self._new_problem = MultiAgentProblem(f'{self._name}_{self._problem.name}', self._env)
