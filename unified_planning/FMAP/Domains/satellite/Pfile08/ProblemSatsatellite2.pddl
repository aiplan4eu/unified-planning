...
(:init (mySatellite satellite2)
 ...
 (= (on_board satellite2) {instrument6 instrument7})
 (not (= (on_board satellite2) {instrument0 instrument1 instrument2 instrument3 instrument4 instrument5 instrument8 instrument9}))
