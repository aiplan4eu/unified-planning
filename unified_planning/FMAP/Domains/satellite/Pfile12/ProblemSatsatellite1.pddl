...
(:init (mySatellite satellite1)
 ...
 (= (on_board satellite1) {instrument3 instrument4})
 (not (= (on_board satellite1) {instrument0 instrument1 instrument2 instrument5 instrument6 instrument7 instrument8 instrument9}))
