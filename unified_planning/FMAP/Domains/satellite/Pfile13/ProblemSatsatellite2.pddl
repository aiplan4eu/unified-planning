...
(:init (mySatellite satellite2)
 ...
 (= (on_board satellite2) {instrument3 instrument4})
 (not (= (on_board satellite2) {instrument0 instrument1 instrument2 instrument5 instrument6 instrument7 instrument8}))
