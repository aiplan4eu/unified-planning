...
(:init (mySatellite satellite4)
 ...
 (= (on_board satellite4) {instrument6 instrument7 instrument8})
 (not (= (on_board satellite4) {instrument0 instrument1 instrument2 instrument3 instrument4 instrument5}))
