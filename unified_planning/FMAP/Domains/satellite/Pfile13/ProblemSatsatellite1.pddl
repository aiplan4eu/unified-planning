...
(:init (mySatellite satellite1)
 ...
 (= (on_board satellite1) {instrument2})
 (not (= (on_board satellite1) {instrument0 instrument1 instrument3 instrument4 instrument5 instrument6 instrument7 instrument8}))
