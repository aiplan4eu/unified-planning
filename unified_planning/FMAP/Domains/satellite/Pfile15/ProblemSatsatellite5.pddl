...
(:shared-data
  ...
  (have_image ?d - direction ?m - mode) - (either satellite0 satellite1 satellite2 satellite3 satellite4 satellite6 satellite7)
)
(:init (mySatellite satellite5)
 ...
 (= (on_board satellite5) {instrument10 instrument11 instrument12})
 (not (= (on_board satellite5) {instrument0 instrument1 instrument2 instrument3 instrument4 instrument5 instrument6 instrument7 instrument8 instrument9 instrument13 instrument14 instrument15 instrument16 instrument17 instrument18}))
