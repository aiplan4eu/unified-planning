...
(either rover0 rover1 rover3 rover4 rover5)
)
(:init (myRover rover2)
 ...
 (not (can_traverse rover2 waypoint1 waypoint14))
 ...
 (not (can_traverse rover2 waypoint3 waypoint13))
 ...
 (not (can_traverse rover2 waypoint3 waypoint18))
 ...
 (not (can_traverse rover2 waypoint4 waypoint13))
 ...
 (not (can_traverse rover2 waypoint6 waypoint18))
 ...
 (not (can_traverse rover2 waypoint9 waypoint18))
 ...
 (not (can_traverse rover2 waypoint10 waypoint15))
 ...
 (not (can_traverse rover2 waypoint12 waypoint14))
 ...
 (not (can_traverse rover2 waypoint13 waypoint3))
 (not (can_traverse rover2 waypoint13 waypoint4))
 ...
 (not (can_traverse rover2 waypoint14 waypoint1))
 ...
 (not (can_traverse rover2 waypoint14 waypoint12))
 ...
 (not (can_traverse rover2 waypoint15 waypoint10))
 ...
 (not (can_traverse rover2 waypoint17 waypoint18))
 ...
 (not (can_traverse rover2 waypoint18 waypoint17))
