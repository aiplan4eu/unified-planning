...
class QuantifierSimplifier(Simplifier):
    ...
    def __init__(self, env: 'unified_planning.environment.Environment', problem: 'up.model.problem.Problem'):
    ...
    def walk_exists(self, expression: 'FNode', args: List['FNode']) -> 'FNode':
        ...
        possible_objects: List[List['up.model.object.Object']] = [list(self._problem.objects(t)) for t in type_list]
