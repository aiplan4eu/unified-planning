...
_PLANREQUEST_ENGINEOPTIONSENTRY = _PLANREQUEST.nested_types_by_name[
    "EngineOptionsEntry"
]
...
_PLANGENERATIONRESULT_METRICSENTRY = _PLANGENERATIONRESULT.nested_types_by_name[
    "MetricsEntry"
]
...
_COMPILERRESULT_MAPBACKPLANENTRY = _COMPILERRESULT.nested_types_by_name[
    "MapBackPlanEntry"
]
...
_VALIDATIONRESULT_VALIDATIONRESULTSTATUS = _VALIDATIONRESULT.enum_types_by_name[
...
Atom = _reflection.GeneratedProtocolMessageType(
    "Atom",
    (_message.Message,),
    {
        "DESCRIPTOR": _ATOM,
...
TypeDeclaration = _reflection.GeneratedProtocolMessageType(
    "TypeDeclaration",
    (_message.Message,),
    {
...
Fluent = _reflection.GeneratedProtocolMessageType(
    "Fluent",
    (_message.Message,),
    {
        "DESCRIPTOR": _FLUENT,
...
ObjectDeclaration = _reflection.GeneratedProtocolMessageType(
    "ObjectDeclaration",
    (_message.Message,),
    {
...
EffectExpression = _reflection.GeneratedProtocolMessageType(
    "EffectExpression",
    (_message.Message,),
    {
...
Effect = _reflection.GeneratedProtocolMessageType(
    "Effect",
    (_message.Message,),
    {
        "DESCRIPTOR": _EFFECT,
...
Timing = _reflection.GeneratedProtocolMessageType(
    "Timing",
    (_message.Message,),
    {
        "DESCRIPTOR": _TIMING,
...
AbstractTaskDeclaration = _reflection.GeneratedProtocolMessageType(
...
TaskNetwork = _reflection.GeneratedProtocolMessageType(
    "TaskNetwork",
    (_message.Message,),
    {
...
Hierarchy = _reflection.GeneratedProtocolMessageType(
    "Hierarchy",
    (_message.Message,),
    {
...
TimedEffect = _reflection.GeneratedProtocolMessageType(
    "TimedEffect",
    (_message.Message,),
    {
...
Metric = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "ActionCostsEntry": _reflection.GeneratedProtocolMessageType(
            "ActionCostsEntry",
            (_message.Message,),
            {
...
ActionInstance = _reflection.GeneratedProtocolMessageType(
    "ActionInstance",
    (_message.Message,),
    {
...
PlanRequest = _reflection.GeneratedProtocolMessageType(
    "PlanRequest",
    (_message.Message,),
    {
        "EngineOptionsEntry": _reflection.GeneratedProtocolMessageType(
            "EngineOptionsEntry",
            (_message.Message,),
            {
...
ValidationRequest = _reflection.GeneratedProtocolMessageType(
    "ValidationRequest",
    (_message.Message,),
    {
...
PlanGenerationResult = _reflection.GeneratedProtocolMessageType(
...
CompilerResult = _reflection.GeneratedProtocolMessageType(
    "CompilerResult",
    (_message.Message,),
    {
        "MapBackPlanEntry": _reflection.GeneratedProtocolMessageType(
            "MapBackPlanEntry",
            (_message.Message,),
            {
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _EXPRESSIONKIND._serialized_start = 4603
    _EXPRESSIONKIND._serialized_end = 4779
    _FEATURE._serialized_start = 4782
    _FEATURE._serialized_end = 5435
    ...
    _METRIC._serialized_start = 2307
    _METRIC._serialized_end = 2719
    _METRIC_ACTIONCOSTSENTRY._serialized_start = 2474
    _METRIC_ACTIONCOSTSENTRY._serialized_end = 2537
    _METRIC_METRICKIND._serialized_start = 2540
    _METRIC_METRICKIND._serialized_end = 2719
    _PROBLEM._serialized_start = 2722
    _PROBLEM._serialized_end = 3076
    _ACTIONINSTANCE._serialized_start = 3079
    _ACTIONINSTANCE._serialized_end = 3207
    _PLAN._serialized_start = 3209
    _PLAN._serialized_end = 3249
    _PLANREQUEST._serialized_start = 3252
    _PLANREQUEST._serialized_end = 3511
    _PLANREQUEST_ENGINEOPTIONSENTRY._serialized_start = 3412
    _PLANREQUEST_ENGINEOPTIONSENTRY._serialized_end = 3464
    _PLANREQUEST_MODE._serialized_start = 3466
    _PLANREQUEST_MODE._serialized_end = 3511
    _VALIDATIONREQUEST._serialized_start = 3513
    _VALIDATIONREQUEST._serialized_end = 3580
    _LOGMESSAGE._serialized_start = 3582
    _LOGMESSAGE._serialized_end = 3705
    _LOGMESSAGE_LOGLEVEL._serialized_start = 3650
    _LOGMESSAGE_LOGLEVEL._serialized_end = 3705
    _PLANGENERATIONRESULT._serialized_start = 3708
    _PLANGENERATIONRESULT._serialized_end = 4155
    _PLANGENERATIONRESULT_METRICSENTRY._serialized_start = 3912
    _PLANGENERATIONRESULT_METRICSENTRY._serialized_end = 3958
    _PLANGENERATIONRESULT_STATUS._serialized_start = 3961
    _PLANGENERATIONRESULT_STATUS._serialized_end = 4155
    _ENGINE._serialized_start = 4157
    _ENGINE._serialized_end = 4179
    _VALIDATIONRESULT._serialized_start = 4182
    _VALIDATIONRESULT._serialized_end = 4368
    _VALIDATIONRESULT_VALIDATIONRESULTSTATUS._serialized_start = 4320
    _VALIDATIONRESULT_VALIDATIONRESULTSTATUS._serialized_end = 4368
    _COMPILERRESULT._serialized_start = 4371
    _COMPILERRESULT._serialized_end = 4600
    _COMPILERRESULT_MAPBACKPLANENTRY._serialized_start = 4533
    _COMPILERRESULT_MAPBACKPLANENTRY._serialized_end = 4600
    _UNIFIEDPLANNING._serialized_start = 5438
    _UNIFIEDPLANNING._serialized_end = 5602
