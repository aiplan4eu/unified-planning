...
class PDDLSolver(solvers.solver.Solver):
    ...
    def solve(self, problem: 'up.model.Problem', callback: Optional[Callable[['up.solvers.results.PlanGenerationResult'], None]] = None, timeout_seconds: Optional[float] = None) -> 'up.solvers.results.PlanGenerationResult':
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            try:
                res = subprocess.run(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE, timeout=timeout_seconds)
                ...
                return PlanGenerationResult(up.solvers.results.TIMEOUT, plan)
        ...
        return PlanGenerationResult(status, plan, log_messages=logs)
