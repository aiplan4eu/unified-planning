...
The library is being developed publicly under a permissive open-source license (Apache 2.0) and the progress and the code can be followed at `Github <https://github.com/aiplan4eu/unified-planning>`_.


Check out our :ref:`Getting Started Guide <getting-started>` and the full :ref:`API Reference <api-ref>`.

Github page of the project available `here <https://github.com/aiplan4eu/unified-planning>`_.
