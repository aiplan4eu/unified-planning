...
def get_example_problems():
    ...
    problem.add_goal(x)
    plan = upf.plan.SequentialPlan([upf.plan.ActionInstance(a_y), upf.plan.ActionInstance(a_x)])
    ...
    problem.add_goal(z)
    plan = upf.plan.SequentialPlan([upf.plan.ActionInstance(a_2_act),
    ...
    plan = upf.plan.TimeTriggeredPlan([(Fraction(0, 1), upf.plan.ActionInstance(take_ok, (ObjectExp(o1), ObjectExp(o2))), Fraction(3, 1)),
                                  (Fraction(1, 1), upf.plan.ActionInstance(set_giver, (ObjectExp(o2), )), Fraction(2, 1))])
