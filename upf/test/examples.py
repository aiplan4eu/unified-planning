...
def get_example_problems():
    ...
    a_x.add_assign_effect(x, True, y)
    a_y.add_precondition(Not(y))
    a_y.add_assign_effect(y, True)
    ...
    move.add_assign_effect(robot_at(l_from), False)
    move.add_assign_effect(robot_at(l_to), True)
    move.add_assign_effect(battery_charge, Minus(battery_charge, 10))
    ...
    load.add_assign_effect(cargo_at(loc), False)
    load.add_assign_effect(cargo_mounted, True)
    ...
    unload.add_assign_effect(cargo_at(loc), True)
    unload.add_assign_effect(cargo_mounted, False)
    l1 = upf.Object('l1', Location)
    l2 = upf.Object('l2', Location)
    ...
    move.add_assign_effect(robot_at(r, l_from), False)
    move.add_assign_effect(robot_at(r, l_to), True)
    ...
    load.add_assign_effect(cargo_at(c, loc), False)
    load.add_assign_effect(cargo_mounted(c,r), True)
    ...
    unload.add_assign_effect(cargo_at(c, loc), True)
    unload.add_assign_effect(cargo_mounted(c,r), False)
    l1 = upf.Object('l1', Location)
    l2 = upf.Object('l2', Location)
